...
export default function MobileMenu({ isPremium }: MobileMenuProps) {
  ...
  return (
    /* ΕΔΩ ΕΙΝΑΙ Η ΑΛΛΑΓΗ: 
       Χρησιμοποιούμε "hidden" (κρυφό παντού) 
       και "max-lg:flex" (εμφάνιση ΜΟΝΟ κάτω από 1024px).
       Αν το βλέπεις ακόμα σε desktop, άλλαξε το "max-lg" σε "max-md".
    */
        ...
        <div className="fixed inset-0 z-[100] bg-[#020617] animate-in fade-in duration-200">
          <div className="p-6 flex flex-col h-full">
            ...
            <div className="mt-auto pb-10 text-center">
               <p className="text-slate-500 text-sm italic">FitnessApp v1.0</p>
            </div>
          </div>
        </div>
      )}
